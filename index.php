...
<div class="container-fluid">
  ...
  <div class="row">
    <div class="col-md-12">
      <div class="fixed-bottom bg-dark text-white"><center>พัฒนาโดย  สำนักงานจังหวัดพัฒลุง   <a href="" data-toggle="modal" data-target="#modelId"  class="btn btn-info btn-sm"><i class="fa fa-code" aria-hidden="true"></i> ติดต่อผู้พัฒนาระบบ</a></center></div>
    </div>
  </div>
</div>
