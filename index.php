...
<nav class="navbar navbar-expand-lg fixed-top navbar-light bg-dark">
  <div class="container-fluid">
      ...
      <a class="navbar-brand text-white" href="#">ข้อมูลเพื่อการติดต่อประสานงานจังหวัดพัทลุง</a>
  </div>
    ...
    <div class="collapse navbar-collapse" id="navbarResponsive">
       <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item">
          <a class="nav-link text-white" href="report.php"><i class="fa fa-download" aria-hidden="true"></i> ไฟล์ excel</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" href="contacts.vcf"><i class="fa fa-download" aria-hidden="true"></i> ไฟล์ vcf (android/ios)</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white" 
            href="https://online.fliphtml5.com/woynu/jzch/"
            data-rel="fh5-light-box-demo"
            data-href="https://online.fliphtml5.com/woynu/jzch/"
            data-width="400" data-height="250" data-title=""><i class="fa fa-bullhorn" aria-hidden="true"></i> E-Book</a>
        </li>
        <li class="nav-item">
          <a class="nav-link text-white"  data-toggle="modal" data-target="#modelId"><i class="fa fa-bullhorn" aria-hidden="true"></i>Username</a>
        </li>
        <li class="nav-item">
