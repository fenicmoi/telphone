...
<form method="POST">
  <div class="form-group">
    ...
    <div class="input-group">
      ...
      <input type="text" id="dep_name" name="dep_name" class="form-control col-10"
        value="<?php print $row['dep_name']; ?>">
    </div>
    <br>
    <div class="input-group">
      <div class="input-group-prepend">
      ...
      <input type="text" id="dep_impo" name="dep_impo" class="form-control col-2"
        value="<?php print $row['dep_impo']; ?>">
    </div>
  </div> <!-- form-group -->
  <br>
  <center>
