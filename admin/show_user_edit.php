    ...
    <div class="form-group">
            ...
            <select name="depart" id="depart" class="selectpicker" data-live-search="true" title="โปรดระบุ">
                <?php
                    ...
                    while ($row_dep = dbFetchArray($result_dep)) {?>
                        <option value="<?php echo $row_dep['dep_id'];?>"  <?php if($dep_id == $row_dep['dep_id']){echo "selected";}?>     >
      ...
      <div class="input-group">
            ...
            <select class="form-control col-2" name="u_type" id="u_type">
                <option value="u" <?php if($u_type == 'u'){ echo "selected";} ?>>User</option>
                <option value="a" <?php if($u_type == 'a'){ echo "selected";} ?>>Admin</option>
            </select>
          ...
          <select class=" selectpicker form-control col-2" data-live-search="true" title="โปรดระบุ" name="prefix" id="prefix">
            <?php 
                ...
                while ($row_prefix = dbFetchArray($result)) {?>
                   <option value="<?php echo $row_prefix['pre_id'];?>" <?php if($pre_id == $row_prefix['pre_id']){echo "selected";}?>>
