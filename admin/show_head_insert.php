...
?>
<form id="insertHeadForm" action="head_add.php" method="POST" enctype="multipart/form-data">

    <div class="input-group mb-2">
        <div class="input-group-prepend">
            <span class="input-group-text">หน่วยงาน</span>
        </div>
        <select name="g_dep" id="g_dep" class="selectpicker form-control" data-live-search="true" title="โปรดระบุ"
            required>
    ...
    <div class="input-group mb-2">
        ...
        <small class="form-text text-muted">- ไฟล์รูปภาพขนาดไม่เกิน 500 kb</small>
    </div>
    ...
    <div class="input-group mb-2">
        ...
        <input type="text" id="g_web" name="g_web" class="form-control" placeholder="http://..." />
    </div>

    <br>
    <center>
        <button type="submit" class="btn btn-primary" id="btnSave" name="btnSave">บันทึก</button>
    </center>
</form>
    ...
    $(document).ready(function () {
        ...
        $("#insertHeadForm").validate({
            ...
            messages: {
                ...
                g_fax: "กรุณาระบุเบอร์โทรสาร",
                g_email: "กรุณาใส่รูปแบบ E-mail ให้ถูกต้อง",
            },
            errorElement: "em",
