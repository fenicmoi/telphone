      ...
      <form action="dep_add.php" method="post">
        <div class="input-group mb-3">
          ...
          <!-- <select class="form-control col-6" name="selMinis" id="selMinis" required> -->
           <select class=" selectpicker form-control col-2" data-live-search="true" title="โปรดระบุ" name="selMinis" id="selMinis">
        ...
        <div class="input-group mb-3">
          ...
          <input type="text"  name="d_name" id="d_name" class="form-control col-10" placeholder="ระบุชื่อหน่วยงาน" required>
        ...
        <div class="input-group">
          <!-- <select class="form-control col-6" name="minis2" id="minis2"> -->
           <select class=" selectpicker form-control col-2" data-live-search="true" title="โปรดระบุ" name="minis2" id="minis2">
              <option value="<?php echo"$minis2";?>" selected><? echo "$m_name2";?></option>
          <?php
